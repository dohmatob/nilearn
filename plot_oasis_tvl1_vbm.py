"""
Voxel-Based Morphometry on Oasis dataset with TV-l1
===================================================
...
slcv = TVl1RegressorCV(verbose=1, n_jobs=n_jobs, memory=memory,
...
### Visualisation
### Look at the TV-l1 discriminating weights
# reverse masking
